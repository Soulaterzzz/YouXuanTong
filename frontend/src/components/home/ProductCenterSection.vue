    ...
    <section class="content product-center-content">
      ...
      <div class="product-list" v-loading="productLoading">
        <OptimizedProductCard
          ...
          :key="product.id"
          v-memo="[product.id, product.saleStatus, product.price, product.stock, product.isNew, product.isHot, product.description, product.features, product.imageUrl, product.templateFileName]"
          :product="product"
          :is-admin="isAdmin"
...
import { Sunny, Star, Present, Grid, Menu, Filter, Setting, Refresh, Plus } from '@element-plus/icons-vue'
