  ...
  <div class="app-container">
    ...
    <main id="main-content" class="main-content">
      <ProductCenterSection
        ...
        @search-keyword-change="handleProductSearchKeywordChange"
        @search-product="searchProducts"
      ...
      <section v-else class="content">
        <HomeOverviewSection
          ...
          @goto-product="handleMenuSelect('product')"
          @goto-insurance="handleMenuSelect('insurance')"
          @goto-expense="handleMenuSelect('expense')"
          @goto-recharge="handleMenuSelect('recharge')"
          @goto-user-admin="handleMenuSelect('userAdmin')"
          @open-notice-dialog="openNoticeDialog($event)"
          @open-notice-manage="openNoticeManageDialog"
        />
        ...
        <RechargeSection
          ...
          :recharge-page-size="rechargePageSize"
